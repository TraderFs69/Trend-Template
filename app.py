...
# Polygon API key (no secrets)
API_KEY = st.text_input("Polygon API Key", "")
...
for i, ticker in enumerate(tickers):
    ...
    # Relative strength approximation
...
st.subheader("Stocks matching Minervini Template")

st.dataframe(
    df_results.sort_values("Return 1Y", ascending=False),
